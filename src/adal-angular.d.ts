...
/*
 *~ Type definitions for adal.js - 'adal-angular' npm package v1.0.17
...
export declare class AuthenticationContext {
     ...
     * @returns {AuthenticationContext.UserInfo} user object
     */
     ...
     * @param {AuthenticationContext.TokenCallback} callback The callback provided by the caller. It will be called with token or error.
     */
    registerCallback(
     ...
     * @param {string} resource Resource URI identifying the target resource.
     * @param {AuthenticationContext.TokenCallback} callback The callback provided by the caller. It will be called with token or error.
     */
     ...
     * @param {string} resource Resource URI identifying the target resource.
     * @param {string} extraQueryParameters Query parameters to add to the authentication request.
     * @param {string} claims Claims to add to the authentication request.
     * @param {AuthenticationContext.TokenCallback} callback The callback provided by the caller. It will be called with token or error.
     */
    acquireTokenPopup(
        resource: string,
     ...
     * @param {AuthenticationContext.UserCallback} callback The callback provided by the caller. It will be called with user or error.
     */
     ...
     * @param {string} hash Hash passed from redirect page
     * @returns {AuthenticationContext.RequestInfo} an object created from the redirect response from AAD comprising of the keys - parameters, requestType, stateMatch, stateResponse and valid.
     */
    getRequestInfo(hash: string): AuthenticationContext.RequestInfo;
    /**
     * Saves token or error received in the response from AAD in the cache. In case of `id_token`, it also creates the user object.
     * @param {AuthenticationContext.RequestInfo} requestInfo 
     */
     ...
     * @param {string} hash Hash fragment of URL. Defaults to `window.location.hash`.
     */
     ...
     */
    _saveItem(key: any, obj: any, preserve?: boolean): boolean;
    /**
...
export function inject(config: AuthenticationContext.Options): AuthenticationContext;

export declare namespace AuthenticationContext {
    /**
     * string enum for RequestType
     * @enum {string}
     */
    type RequestType = 'LOGIN' | 'RENEW_TOKEN' | 'UNKNOWN';
    /**
     * string enum for ResponseType
     * @enum {string}
     */
    type ResponseType = 'id_token token' | 'token';
    /**
     * number enum for LoggingLevel
     */
     ...
     * @param {string} tokenType token type returned from AAD if token request is successful.
     */
    type TokenCallback = (
     ...
     * @param {UserInfo} user user object retrieved from the cache.
     */
    type UserCallback = (
        errorDesc: string | null,
        user: UserInfo | null
